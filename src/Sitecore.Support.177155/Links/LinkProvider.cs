    ...
    public class LinkProvider : Sitecore.Links.LinkProvider
    {
        ...
        public new class LinkBuilder : Sitecore.Links.LinkProvider.LinkBuilder
        {
            ...
            protected override string GetServerUrlElement(SiteInfo siteInfo)
            {
                ...
                string str4 = ((!string.IsNullOrEmpty(siteInfo.HostName) && !string.IsNullOrEmpty(hostName)) && DoesHostNameMatchSiteInfo(hostName, siteInfo))/*siteInfo.Matches(hostName))Sitecore.Support.177155*/ ? hostName : StringUtil.GetString(new string[] { this.GetTargetHostName(siteInfo), hostName });
